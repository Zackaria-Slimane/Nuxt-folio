...
export default defineNuxtConfig({
	...
	runtimeConfig: {
		public: {
			titleSeparator: "|",
			trailingSlash: true,
			siteUrl: process.env.NUXT_PUBLIC_SITE_URL || "https://zackariasl.ma/",
		...
		head: {
			...
			meta: [
				...
				{ name: "og:description", content: "Zackaria SLIMANE - Front-end Web Developer portfolio" },
				{
					...
					content: "Zackaria SLIMANE - Front-end Web Developer portfolio",
				},
				...
				},
				{
					...
					content: "Zackaria SLIMANE - Front-end Web Developer",
				},
				{ charset: "UTF-8" },
			...
			link: [
				...
				{ rel: "canonical", href: "https://zackariasl.ma" },
